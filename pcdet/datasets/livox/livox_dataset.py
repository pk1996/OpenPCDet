...
class LivoxDataset(DatasetTemplate):
    ...
    def get_lidar(self, idx):
        ...
        lidar_number = [1,2,5] # frontal 3 lidars
        points_filt = []
        ...
        # points_ = points[np.logical_or(points[:,-1] == 1 , points[:,-1] ==2, points[:,-1] == 5), :]
        # points_ = points[:,0:3]
        return points_filt #points 
        ...
        def process_single_scene(sample_idx):
            ...
            if has_label:
                ...
                if len(obj_list) != 0:
                    ...
                    # TODO - See the importance of these lines
                    '''
                    Assumption - KITTI reports its 3D bbox coordinates in the camera coordinate
                    frame and call to rect_to_lidar is to transform it to lidar. In case of livox
                    it is the same
                    '''
